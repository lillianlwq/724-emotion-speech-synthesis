...
from pitch_increase import emotional_prosody_modulation_happy, compute_spectrum, plot_spectrum, increase_pitch
from angry_sppech import modify_audio_for_anger
...
def add_emotion_to_speech(emotion_type, input_wav, output_wav):
    ...
    if (emotion_type == 'happy'):
        ...
        plot_spectrum(original_DB_surprise, modified_DB_surprise)
        sf.write(output_wav, modified_DB_surprise, sr)
    else:
        return
